...
class ApplicationMain {
	...
	private static function preload() {
		...
		// assets:
		loadBinary("assets/data/80.csv");
		loadBinary("assets/data/attract1.fgr");
		loadBinary("assets/data/attract2.fgr");
		loadBinary("assets/data/data-goes-here.txt");
		loadFile("assets/images/bot.png");
		loadFile("assets/images/bot_bullet.png");
		loadFile("assets/images/bullet.png");
		loadFile("assets/images/cursor.png");
		loadFile("assets/images/dirt.png");
		loadFile("assets/images/dirt_top.png");
		loadFile("assets/images/gibs.png");
		loadBinary("assets/images/images-go-here.txt");
		loadFile("assets/images/img_tiles.png");
		loadFile("assets/images/jet.png");
		loadFile("assets/images/miniframe.png");
		loadFile("assets/images/spaceman.png");
		loadFile("assets/images/spawner.png");
		loadFile("assets/images/spawner_gibs.png");
		loadFile("assets/images/tech_tiles.png");
		loadBinary("assets/music/music-goes-here.txt");
		loadSound("assets/sounds/asplode.mp3");
		loadSound("assets/sounds/asplode.ogg");
		loadSound("assets/sounds/button.mp3");
		loadSound("assets/sounds/button.ogg");
		loadSound("assets/sounds/countdown.mp3");
		loadSound("assets/sounds/countdown.ogg");
		loadSound("assets/sounds/enemy.mp3");
		loadSound("assets/sounds/enemy.ogg");
		loadSound("assets/sounds/hit.mp3");
		loadSound("assets/sounds/hit.ogg");
		loadSound("assets/sounds/hurt.mp3");
		loadSound("assets/sounds/hurt.ogg");
		loadSound("assets/sounds/jam.mp3");
		loadSound("assets/sounds/jam.ogg");
		loadSound("assets/sounds/jet.mp3");
		loadSound("assets/sounds/jet.ogg");
		loadSound("assets/sounds/jump.mp3");
		loadSound("assets/sounds/jump.ogg");
		loadSound("assets/sounds/menu_hit.mp3");
		loadSound("assets/sounds/menu_hit.ogg");
		loadSound("assets/sounds/menu_hit_2.mp3");
		loadSound("assets/sounds/menu_hit_2.ogg");
		loadSound("assets/sounds/mode.mp3");
		loadSound("assets/sounds/mode.ogg");
		loadSound("assets/sounds/shoot.mp3");
		loadSound("assets/sounds/shoot.ogg");
		...
		loadFile("images/bot.png");
		loadFile("images/bot_bullet.png");
		loadFile("images/bullet.png");
		loadFile("images/cursor.png");
		loadFile("images/dirt.png");
		loadFile("images/dirt_top.png");
		loadFile("images/gibs.png");
		loadBinary("images/images-go-here.txt");
		loadFile("images/img_tiles.png");
		loadFile("images/jet.png");
		loadFile("images/miniframe.png");
		loadFile("images/spaceman.png");
		loadFile("images/spawner.png");
		loadFile("images/spawner_gibs.png");
		loadFile("images/tech_tiles.png");
		loadBinary("data/80.csv");
		loadBinary("data/attract1.fgr");
		loadBinary("data/attract2.fgr");
		loadBinary("data/data-goes-here.txt");
		loadSound("assets/sounds/asplode.mp3");
		loadSound("assets/sounds/button.mp3");
		loadSound("assets/sounds/countdown.mp3");
		loadSound("assets/sounds/enemy.mp3");
